  ...
  _pipelines: [
    {
      ...
      name: '发现新源',
      icon: '🔍',
      desc: '启动统一采集入口的页面发现阶段，复用同一运行锁、重试状态和运行记录。',
      endpoint: '/api/v1/pipeline/discover',
      body: {},
      duration: '1-2 分钟',
      danger: 'safe',
      confirm: '启动页面发现任务。任务会在后台运行，并复用定时采集的状态记录。继续？',
    },
    {
      key: 'scrape-images',
      name: '抓取图片',
      icon: '📥',
      desc: '消费统一采集 backlog，执行下载、来源关联和内容去重。',
      endpoint: '/api/v1/pipeline/scrape-images',
      body: {},
      duration: '5-30 分钟',
      danger: 'medium',
      confirm: '启动 backlog 下载任务。已有采集实例运行时会由统一锁拒绝重复执行。继续？',
    },
    {
      key: 'generate',
      name: '生成每日 Pack',
      icon: '✨',
      desc: '从统一候选池生成研究图集；活跃待审图集中的素材会继续占位。',
      endpoint: '/api/v1/pipeline/generate',
      body: {},
      duration: '1-2 分钟',
      danger: 'safe',
      confirm: '启动候选生成任务。重复或仍待审核的素材不会再次进入新图集。继续？',
    },
    {
      key: 'full',
      name: '完整跑一遍',
      icon: '🚀',
      desc: '启动与 mini 定时任务相同的完整采集链路。',
      endpoint: '/api/v1/pipeline/full',
      body: {},
      duration: '10-30 分钟',
      danger: 'medium',
      confirm: '启动完整统一采集任务，任务在后台执行。确认继续？',
    },
    // 自动发布永久禁用（2026-07-29 关停）：CDP 发布卡片与后端 /cdp-publish 端点已移除。
    // 发布流程 = 编辑台导出/下载发布包 → 人工发布 → 发布账本登记。
  ],
